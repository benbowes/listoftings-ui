...
const prefixLawNewZealandRoute = require("./routes/page/prefix-lawyers-new-zealand")(
  app
);
const searchLawyersRoute = require("./routes/page/search-lawyers-by-speciality")(
  app
);
const findALawyerOnAMap = require("./routes/page/find-a-lawyer-on-a-map")(app);
const pitchAProjectRoute = require("./routes/page/pitch-a-project-for-a-lawyer")(
  app,
  csrfProtection
);
const pitchProjectSendRoute = require("./routes/rest/send")(
  parseForm,
  csrfProtection
);
