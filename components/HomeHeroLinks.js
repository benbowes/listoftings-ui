    ...
    return (
      <div className="home-hero-links">
        <div className="home-hero-links__box">
          <Link
            href="/search-lawyers-by-speciality?ajax=1"
            as="/search-lawyers-by-speciality/"
          >
            <a
              role="button"
              tabIndex="0"
            ...
            >
              ...
              <span
                className={`button-circle ${
                  selectedSection === "search" ? "button-circle--open" : ""
                }`}
              >
                {"~"}
              </span>
        ...
        <div className="home-hero-links__box">
          ...
          >
            ...
            <span
              className={`button-circle ${
                selectedSection === "pitch" ? "button-circle--open" : ""
              }`}
            >
              {"~"}
            </span>
