...
module.exports = (app) =>
  lawyerSpecialityRoute.get(
    "/lawyer-specialty/:slug/:region/:page?",
    (req, res) => {
      const from = req.params.page
      ...
      if (query) {
        queryElasticSearch({ bool: { must: query } }, _source, from).then(
          (es_res) =>
            handleResponse(req, res, es_res, "/lawyer-specialty", app),
